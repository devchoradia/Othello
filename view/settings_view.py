...
class SettingsView(GridPageView):
    ...
    def add_settings(self, start_row):
        for index, setting in enumerate(Setting):
            ...
            tile = tk.Label(label_frame, borderwidth=1, font=("Palatino", 20), width=COLUMN_WIDTHS[0], height=ROW_HEIGHT, text=Settings().get_setting_label(setting), bg="white", fg="black")
    ...
    def add_column_labels(self, row):
        for index, column in enumerate(COLUMNS):
            ...
            tile = tk.Label(frame, font=BUTTON_FONT, borderwidth=1, width=COLUMN_WIDTHS[0], height=ROW_HEIGHT, text=column,bg="gray")

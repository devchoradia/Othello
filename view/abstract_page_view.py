...
class PageView(AbstractPageView):
    ...
    def add_title(self):
        ...
        label = tk.Label(title_frame, bg=APP_COLOR, relief=tk.RAISED, borderwidth=1, height=ROW_HEIGHT,
                         font=("Palatino", 40), text=self.title, fg="black")
        label.pack(expand=True, fill=tk.BOTH)

    def add_navigator(self):
        frame = tk.Frame(self, borderwidth=1, bg=APP_COLOR, highlightbackground='black', highlightcolor='black',
...
class GridPageView(AbstractPageView):
    ...
    def add_title(self):
        ...
        label = tk.Label(self, relief=tk.RAISED, bg=APP_COLOR, borderwidth=1, height=ROW_HEIGHT, font=("Palatino", 40),
                         text=self.title, fg="black")
    ...
    def add_navigator(self, row):
        ...
        home_button = tk.Button(home_frame, font=HOME_BUTTON_FONT, text=VIEW_TITLES[Views.HOME], borderwidth=2,
                                height=ROW_HEIGHT, \
                                command=self.on_home, bg=APP_COLOR, highlightbackground=APP_COLOR)
